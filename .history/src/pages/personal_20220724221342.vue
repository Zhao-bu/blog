<template>
    <div>
        ...
        <div class="v-grid">
            ...
            <div>
                <v-edit-card @onSubmit='onSubmit' v-if="showEdit"></v-edit-card>
                <el-card class="box-card-one" shadow="hover" v-else>
                    <div class="card1">
            ...
            <div class="grid-right">
                <el-card class="box-card-two" shadow="hover">
                    <div class="v-grid-two">
                        <div>
                            <p>关注了</p>
                            <p class="font-number">1</p>
                        </div>
                        <div>
                            <p>关注者</p>
                            <p class="font-number">1</p>
...
import vEditCard from "@/components/v-edit-card";
export default {
    components: {
        vHeader,
        vEditCard
...
.synopsis :nth-child(1) {
    font-size: 24px;
    font-weight: 600;
    margin: 20px 0 0 0;
}

.synopsis :nth-child(n + 2) {
    color: gray;
    margin: 5px 0 5px 0;
}
</style>